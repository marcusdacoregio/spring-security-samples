...
import org.springframework.security.web.server.authentication.session.InvalidateLeastUsedMaximumSessionsExceededHandler;
import org.springframework.security.web.server.authentication.session.PreventLoginMaximumSessionsExceededHandler;
import org.springframework.security.web.server.authentication.session.ServerMaximumSessionsExceededHandler;
...
public class SecurityConfig {
	...
	private Function<Authentication, Mono<Integer>> maxSessions() {
	...
	private ServerMaximumSessionsExceededHandler maximumSessionsExceededHandler() {
		if (this.preventLogin) {
			return new PreventLoginMaximumSessionsExceededHandler();
		}
		return new InvalidateLeastUsedMaximumSessionsExceededHandler();
	}
