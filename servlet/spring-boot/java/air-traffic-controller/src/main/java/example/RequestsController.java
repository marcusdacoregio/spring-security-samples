...
public class RequestsController {
	...
	@GetMapping
	public List<TakeOffRequest> getAllRequests() {
	...
	public void approveRequest(@PathVariable String flightNumber, @RequestBody ApprovalRequest approvalRequest) {
		this.requestsService.approveRequest(flightNumber, approvalRequest);
	}
